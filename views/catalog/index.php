                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 padding-right">
                        <div class="features_items"><!--features_items-->
                            ...
                            <?php foreach($latestProducts as $prodItem): ?>

                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="<?= Product::getImage($prodItem['id']); ?>" alt="" />
                                            <h2><?= $prodItem['price'] ?> грн</h2>
                                            <p><a href="/product/<?= $prodItem['id'] ?>">
                                                <?= $prodItem['name'] ?>
                                            </a></p>
                                            <a href="#" data-id="<?= $prodItem['id'] ?>" class="btn btn-default add-to-cart">
